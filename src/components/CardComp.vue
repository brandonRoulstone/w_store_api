        ...
        <div class="mt-2 pt-5 px-2 container" id="cardBox">
            <div class="card m-1 d-flex" style="width: 18rem;" v-for='product in searchByName() || sortBy()' v-bind:key='product.product_id'>
                ...
                <div class="card-body border-top">
                  ...
                  <router-link @click="fetchProduct(product.product_id)" :to="{ name: 'product', params: { productId: product.product_id }} " class="btn btn-dark">details</router-link>
                    <button class="btn bg-black text-white mx-1">View more <i class="fa-regular fa-eye fa-sm" style="color: #ffffff;"></i></button>
                </div>
            </div>
        </div>
    </div>
